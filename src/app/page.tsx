...
export default function Home() {
  return (
    <div className="w-full">
      ...
      <div  id="presentacion" 
        style={{
          background: "linear-gradient(to right, rgba(245, 245, 245, 0.8), rgba(245, 245, 245, 0.8)),url('https://www.rammaheshwari.com/assets/svg/common-bg.svg')",
        ...
        <div className=" bg-opacity-50 p-10 rounded-lg">
          <h1 className="text-center font-bold text-[70px] ">HOLA, YO SOY KEVIN HUAMAN.</h1>
          ...
          <div id="button" className="flex justify-center align-items-center ">
            <button className="bg-[#7843e9] hover:transition text-white font-bold py-2 px-4 rounded hover:-translate-y-2  transform duration-200 ps-[70px] pe-[70px] pt-[10px] pb-[10px] text-2xl">
             Proyectos
            </button>  
          </div>
      ...
      <div id="about" className="bg-gray-100 text-black p-4 font-bold text-[16px] pt-[100px]">
        <VistaAbout />
      </div>
    </div>
  );
